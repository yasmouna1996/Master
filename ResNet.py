...
class NiftiDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img = resample(img)
       #print("Shape after first resampling:", img.shape)

        crop_or_pad = tio.CropOrPad((315,315,315))
        img = crop_or_pad(img)
...
lr = 0.0005851358822963424
batch_size = 2
dropout_rate = 0.10248318582778085
#noise_prob = 0.4336880
flip_prob = 0.18254280075419682
...
# Model definition (ResNet) and move to device 
model = ResNet(
    spatial_dims=3,
    n_input_channels=1,
    num_classes=2,
