...
class NiftiDataset(Dataset):
    def __init__(self, image_paths, labels, transform=None):
        ...
        self.labels = labels  # List of corresponding labels (e.g., segmentation masks or classification labels)
...
transform = Compose([
    Resize(spatial_size=(128, 128, 128)),  # Resize to a consistent shape (example size)
])

# Create the dataset and dataloaders
train_dataset = NiftiDataset(image_paths=train_image_paths, labels=train_labels, transform=transform)
